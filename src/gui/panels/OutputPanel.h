...
class QTextEdit; class QPushButton; class QTableWidget; class QTabWidget;
class QLineEdit; class QLabel; class QSplitter; class QFrame; class QVBoxLayout;
...
public slots:
    ...
    void addResult(const QString &caseName,
                   ...
                   std::shared_ptr<const QEP::QuadraticEigenvalueResult> result,
                   double sigma = 0.0);
