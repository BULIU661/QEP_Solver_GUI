//==============================================================================
//  src/gui/styles/StyleConstants.h  —  全局 Qt 样式表常量
//==============================================================================
...
constexpr const char* kGlobalStyleSheet = R"(
    ...
    QGroupBox {
        font-weight: bold; border: 1px solid #c0c0c0; border-radius: 4px;
        margin-top: 12px; padding-top: 16px; background-color: #ffffff;
    }
    QGroupBox::title { subcontrol-origin: margin; subcontrol-position: top left;
        padding: 4px 8px; color: #2c3e50; }
    QPushButton { background-color: #3498db; color: white; border: none;
        border-radius: 3px; padding: 6px 16px; font-weight: bold; }
    QPushButton:hover { background-color: #2980b9; }
    QPushButton:pressed { background-color: #2471a3; }
    QPushButton:disabled { background-color: #bdc3c7; }
    QTableWidget { gridline-color: #e0e0e0; selection-background-color: #d5e8f7;
        border: 1px solid #c0c0c0; }
    QTableWidget::item { padding: 4px; }
    QHeaderView::section { background-color: #ecf0f1; padding: 4px;
    ...
    QStatusBar { background-color: #ecf0f1; border-top: 1px solid #c0c0c0; }
    QProgressBar { border: 1px solid #c0c0c0; border-radius: 3px;
        text-align: center; background-color: #ecf0f1; }
    QProgressBar::chunk { background-color: #3498db; border-radius: 2px; }
    QSpinBox, QDoubleSpinBox { border: 1px solid #c0c0c0; border-radius: 3px;
        padding: 2px 4px; background-color: #ffffff; }
    QSpinBox:focus, QDoubleSpinBox:focus { border-color: #3498db; }
    QCheckBox { spacing: 6px; }
    QSplitter::handle { background-color: #bdc3c7; width: 5px; }
    QSplitter::handle:hover { background-color: #3498db; }
    QTreeView { border: none; background-color: #ffffff; font-size: 10pt; }
    QTreeView::item { padding: 5px 4px; border-bottom: 1px solid #f0f0f0; }
    QTreeView::item:hover { background-color: #ebf5fb; }
    QTreeView::item:selected { background-color: #d5e8f7; color: #2c3e50; }
    QTabWidget::pane { border: 1px solid #c0c0c0; border-radius: 4px; background-color: #ffffff; }
    QTabBar::tab { background-color: #ecf0f1; border: 1px solid #c0c0c0; border-bottom: none;
        border-top-left-radius: 4px; border-top-right-radius: 4px; padding: 8px 20px;
        margin-right: 2px; color: #555555; }
...
constexpr const char* kDarkTab = R"(
    QTabWidget::pane { border: 1px solid #3c3c3c; border-radius: 4px; background: #1e1e1e; }
...
constexpr const char* kConfigTabStyle = R"(
    QTabWidget::pane { border: 1px solid #e8e8e8; border-radius: 4px; background: #fafafa; }
...
constexpr const char* kPresetStyle = R"(
    QComboBox { padding: 6px 12px; border: 1px solid #d0d0d0;
        border-radius: 4px; background: #fafafa; }
    QComboBox:hover { border-color: #3498db; }
)";

constexpr const char* kGroupTitleStyle = R"(
    QLabel { color: #2c3e50; font-weight: bold; font-size: 11pt;
        padding: 8px 12px; background: #f8f9fa; border-bottom: 1px solid #e8e8e8; }
)";
